...
% defines ODE on spongy moth and foliage dynamic system (Model 1)
%
% Input: 
%     t             - time (years)
%     Y             - State vector [N, F]
...
%% ---------- ODE SYSTEM ----------
dNdt = r * N * (1 - N/(K * F)) - beta * (N^2) / (alpha^2 + N^2); % rate of change of moth population
dFdt = r_F * F * (1 - F) - gamma * N * F; % rate of change of foliage fraction
